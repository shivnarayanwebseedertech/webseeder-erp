...
import { MdChatBubbleOutline, MdCurrencyRupee } from "react-icons/md";
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: <FaUniversity />,
          to: "/bank-reconciliation-list",
        },
        { label: "Journal Voucher", icon: <FaBook />, to: "/journal-voucher" },
      ],
    },
    {
      title: "Business review",
      items: [{ label: "Reports", icon: <ImStatsBars />, to: "/reports" }],
    },
    {
      title: "Inventory",
      items: [
