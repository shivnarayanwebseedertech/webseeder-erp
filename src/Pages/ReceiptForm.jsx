...
export default function ReceiptForm() {
  const [formData, setFormData] = useState({
    ...
    amountReceived: "0.00",
    receiptDate: "28-06-2025",
    mode: "Cheque",
    referenceNo: "ADV012",
    depositTo: "",
    amountReceivedInput: "0.00",
    enableGST: false,
    findInvoiceNo: "",
    invoiceFromDate: "",
    invoiceToDate: "",
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200 px-4 sm:px-6 py-4">
        <div className="flex items-center gap-4">
          ...
          <span className="text-gray-500">(R0001)</span>
      ...
      <div className="max-w-[1400px] mx-auto p-4 sm:p-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-4 mb-4">
            ...
            <div>
              ...
              <div className="relative">
                <select
                  ...
                  onChange={(e) => handleFormChange("depositTo", e.target.value)}
                >
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <input
                type="number"
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                value={formData.amountReceivedInput}
                onChange={(e) => handleFormChange("amountReceivedInput", e.target.value)}
              />
            </div>
          </div>
          ...
          <div className="mb-4">
            <div className="flex items-center">
              <input
                ...
                onChange={(e) => handleFormChange("enableGST", e.target.checked)}
                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
              <label htmlFor="enableGST" className="ml-2 text-sm text-gray-900">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6 mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Find Invoice No.</label>
              <input
                type="text"
                placeholder="Find Invoice No."
                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                value={formData.findInvoiceNo}
                onChange={(e) => handleFormChange("findInvoiceNo", e.target.value)}
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Invoice From Date</label>
              <div className="relative">
                <input
                  type="text"
                  className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  value={formData.invoiceFromDate}
                  onChange={(e) => handleFormChange("invoiceFromDate", e.target.value)}
                />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                  <CalendarIcon />
                </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  type="text"
                  className="w-full px-3 py-2 pr-10 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                  value={formData.invoiceToDate}
                  onChange={(e) => handleFormChange("invoiceToDate", e.target.value)}
                />
                <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
                  <CalendarIcon />
                </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1">
            <div className="bg-white rounded-lg border border-gray-200 p-4 sm:p-6">
              ...
              <div className="relative">
                <textarea
                  placeholder="Write your narration for this receipt."
