...
export default function ItemCategory({ collapsed }) {
  ...
  const handleSave = () => {
    console.log("Saving item category:", formData);
        ...
        <div className="flex flex-col items-center justify-center text-center space-y-6 py-12 w-full">
          <div className="w-full max-w-lg aspect-video bg-black/5 rounded overflow-hidden">
            <iframe
              ...
              title="How to create item categories"
              frameBorder="0"
          ...
          <p className="text-gray-500">
            Configure your Category for product & service management.
          </p>
          <div className="flex space-x-4">
            ...
            >
              <AiOutlinePlus className="mr-2" /> Create Category
            </button>
